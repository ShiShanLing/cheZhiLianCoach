...
- (void)versionUpdate{
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT,0), ^{
        ...
        NSString *URL_Str = [[NSString alloc] initWithFormat:@"https://itunes.apple.com/cn/lookup?id=%@",@"1314836414"];
        NSMutableDictionary *URL_Dic = [NSMutableDictionary dictionary];
...
-(void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex {
    if (buttonIndex ==1) {
        NSString *url =@"https://itunes.apple.com/cn/app/%E8%BD%A6%E6%99%BA%E8%81%94%E6%95%99%E7%BB%83%E7%AB%AF/id1314836414?mt=8";//
